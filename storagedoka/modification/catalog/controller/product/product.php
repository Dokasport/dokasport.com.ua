...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			if(isset($uniset['product']['option_img_prop'])) {
				...
				foreach ($option['product_option_value'] as $option_value) {
					if (!$option_value['subtract'] || ($option_value['quantity'] > 0)) {
						...
						$product_option_value_data[] = array(
							...
							'image'                   => $option_value['image'] ? $this->model_tool_image->resize($option_value['image'], $option_img_small_w/4, $option_img_small_h/4) : '',
	...
	public function review() {
			...
			$this->load->language('product/product');
			$uniset = $this->config->get('config_unishop2');
			$show_plus_minus_review = isset($uniset['show_plus_minus_review']) ? $uniset['show_plus_minus_review'] : '';
		...
		foreach ($results as $result) {
			...
			'plus'      	=> $show_plus_minus_review ? nl2br($result['plus']) : '',
			'minus'       	=> $show_plus_minus_review ? nl2br($result['minus']) : '',
