...
class ControllerExtensionModuleUniQuickOrder extends Controller {
	...
	public function add() {
		...
		if ($product_info) {
			...
			foreach ($product_options as $product_option) {
				...
				if(isset($option[$product_option['product_option_id']])) {
					foreach($product_option['product_option_value'] as $value) {
						if($value['product_option_value_id'] == $option[$product_option['product_option_id']]) {
			...
			$total_products_summ = $this->tax->calculate((float)$product_info['special'] ? (float)$product_info['special'] : $product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax')) * $quantity;
